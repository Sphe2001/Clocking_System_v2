...
const ViewSupervisorProfile = () => {
  return (
    <div className="min-h-screen flex flex-col p-10  bg-gradient-to-b from-blue-100 to-green-200 backdrop-blur-md rounded-lg shadow-lg">
      {/* Navbar */}
      <SupervisorNavbar />
      {/* profile */}
      ...
      <div className="flex flex-col items-center w-full h-full p-10 flex-grow pb-10 text-white px-6 sm:px-8 md:px-12 ">
        <div className="relative z-10 max-w-lg w-full text-center space-y-6 p-20 bg-gradient-to-b from-white to-green-200 bg-opacity-10 backdrop-blur-md rounded-lg shadow-lg">
         
          {/* Profile Picture */}
          <img 
            src="/images/userimage.png" 
            alt="Profile " 
            className="w-50 h-50 rounded-full mx-auto text-black border-4 border-green-600 shadow-md animate-spin-slow"
          />
          
          <h2 className="text-7xl  font-extrabold  text-blue-500">John Doe</h2>
